...
function CookieConsentInfo() {
  return (
    <>
      <p className="py-4">Last updated: June 05, 2024</p>
      <p className="py-4">
      ...
      <h3>Definitions</h3>
      <p className="py-4">For the purposes of this Cookies Policy:</p>
      <ul>
        <li>
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Cookies Policy) refers to Personal Finance Tracker.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Personal Finance Tracker,
          accessible from{" "}
          <a
            href="https://siryk-university-personalfinancetracker-1.onrender.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://siryk-university-personalfinancetracker-1.onrender.com
          </a>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <p className="py-4">Type: Session Cookies</p>
          <p className="py-4">Administered by: Us</p>
          <p className="py-4">
        ...
        <li>
          ...
          <p className="py-4">Type: Persistent Cookies</p>
          <p className="py-4">Administered by: Us</p>
          <p className="py-4">
      ...
      <ul>
        <li>By email: rss.parser.bot@gmail.com</li>
      </ul>
    </>
  );
}
